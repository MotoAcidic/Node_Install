...
OPTIONS=(1 "v5 pivx and below"
		 2 "v5 pivx and higher"
...
case $CHOICE in
        ...
        1)	# Below version 5 pivx
		cd
		cd Node_Install/Coins/Pivx/v5_below
		bash compile_or_node.sh
        ;;

		2)	# Version 5 or higher pivx
		cd
		cd Node_Install/Coins/Pivx/v5_higher
		bash compile_or_node.sh
        ;;
